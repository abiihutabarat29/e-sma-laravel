                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="javascript:void(0)" id="createNewJur" class="btn btn-info btn-xs float-right">
...
@section('script')
    <script>
        $(function() {
            ...
            $("body").on("click", ".deleteJur", function() {
                var jurusan_id = $(this).data("id");
