                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('pegawai.create') }}" class="btn btn-info btn-sm float-left mr-2">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center>
                        <h6>Apakah anda yakin menghapus Pegawai ini ?</h6>
                    </center>
                </div>
        ...
        $(function() {
            ...
            $("body").on("click", ".deletePegawai", function() {
                ...
                $("#hapusBtn").click(function(e) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('pegawai.store') }}" + "/" + pegawai_id + "/destroy",
                        data: {
                            _token: "{!! csrf_token() !!}",
                        },
