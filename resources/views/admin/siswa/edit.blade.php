        ...
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('siswa.update', Crypt::encryptString($siswa->id)) }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="tempat_lahir" name="tempat_lahir" class="form-control  @error('tempat_lahir') is-invalid @enderror"
                                                        rows="3">{{ old('tempat_lahir', $siswa->tempat_lahir) }}</textarea>
                                                    @error('tempat_lahir')
                                                        <span
                                                            class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="Kristen Protestan"
                                                            {{ $siswa->agama == 'Kristen Protestan' ? 'selected' : '' }}>
                                                            Kristen
                                                            Protestan
                                                        </option>
                                                        <option value="Kristen Katholik"
                                                            {{ $siswa->agama == 'Kristen Katholik' ? 'selected' : '' }}>
                                                            Kristen Katholik
                                                        </option>
                                                        <option value="Hindu"
                                                            {{ $siswa->agama == 'Hindu' ? 'selected' : '' }}>Hindu
                                                        </option>
                                                        <option value="Budha"
                                                            {{ $siswa->agama == 'Budha' ? 'selected' : '' }}>Budha
                                                        </option>
                                                    </select>
                                                    @error('agama')
                                                        <span
                                        ...
                                        {{-- <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="IPA"
                                                        {{ $siswa->jurusan == 'IPA' ? 'selected' : '' }}>
                                                        IPA
                                                    </option>
                                                    <option value="IPS"
                                                        {{ $siswa->jurusan == 'IPS' ? 'selected' : '' }}>
                                                        IPS
                                                    </option>
                                                    <option value="Bahasa"
                                                        {{ $siswa->jurusan == 'Bahasa' ? 'selected' : '' }}>Bahasa
                                                    </option>
                                                </select>
                                                @error('jurusan')
                                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    autocomplete="off" value="{{ old('thnmasuk', $siswa->tahun_masuk) }}"
                                                    onkeypress="return hanyaAngka(event)">
                                                @error('thnmasuk')
                                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    autocomplete="off" value="{{ old('nohp', $siswa->nohp) }}"
                                                    onkeypress="return hanyaAngka(event)">
                                                @error('nohp')
                                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    autocomplete="off" value="{{ old('email', $siswa->email) }}">
                                                @error('email')
                                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                                @enderror
                                            </div>
                                ...
                                <div class="tab-pane" id="tabfoto">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                @if ($siswa->foto == null)
                                                    <img src="{{ url('storage/foto-siswa/blank.png') }}"
