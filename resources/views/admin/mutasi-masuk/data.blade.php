                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('mutasi-masuk.create') }}" class="btn btn-info btn-xs float-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center>
                        <h6>Apakah anda yakin menghapus Siswa Pindahan ini ?</h6>
                    </center>
                </div>
...
@section('script')
    <script>
        $(function() {
            ...
            $("body").on("click", ".deleteMutasiM", function() {
                ...
                $("#hapusBtn").click(function(e) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('mutasi-masuk.store') }}" + "/" + mutasi_id +
                            "/destroy",
                        data: {
                            _token: "{!! csrf_token() !!}",
                        },
